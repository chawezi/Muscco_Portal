<?php  
  ...
  $member = $con->getRows('muscco_members a, system_users b', array('where'=>'a.muscco_member_id="'.$member_id.'" and a.muscco_member_id=b.member_id','return_type'=>'single'));
?>
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
        ...
        <div class="col-9">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Staff Info</li>
            </ol>
          </nav>
        </div>
        <div class="col-3">
  ...
  <ul class="nav nav-pills p-3 mb-3 rounded align-items-center card flex-row">
    <li class="nav-item">
      <h4 class="fw-semibold mb-8">Staff Information</h4>
    </li>
    <li class="nav-item ms-auto">
      <a href="dashboard.php?page=users_list" class="btn btn-primary d-flex align-items-center px-3" id="add-notes">
       <i class="ti ti-users me-0 me-md-1 fs-4"></i>
        <span class="d-none d-md-block font-weight-medium fs-3">Muscco Staff</span>
      </a>
    </li>
  </ul>
  <div class="card">
                      ...
                      <div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="mb-3">
                                ...
                                <select class="form-control form-select" name="band" tabindex="1" required>
                                  <option value="">Select Band</option>
                                  <?php
                                    $bands = $con->getRows('band_rates', array('order_by'=>'band_title'));
                                    if(!empty($bands)){
                                      foreach ($bands as $post) {
                                        echo'<option value="'.$post['band_id'].'"';if($post['band_id'] == $member['band_id']){echo"selected";}echo'>'.$post['band_title'].'</option>';
                                      }
                                    }
                                  ?>
                                </select>
                                  ...
                                  <?php
                                    ...
                                    if(!empty($branches)){
                                      foreach ($branches as $branch) {
                                        echo'<option value="'.$branch['branch_id'].'"';if($branch['branch_id']==$member['branch']){echo "selected";} echo'>'.$branch['branch_name'].'</option>';
                                      }
                                    }
                                  ?>
                                </select>
                        ...
                        <div class="col-12">
                          <div class="d-flex align-items-center justify-content-end mt-4 gap-3">
                            ...
                            <input type="hidden" name="current_image" value="<?=$member['thumb']?>">
