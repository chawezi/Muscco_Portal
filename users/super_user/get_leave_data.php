            ...
            <td>
              <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                  
                  ...
                  <button class="btn btn-sm btn-danger btn-sm btn_ticket_delete" data-id3="<?=$member['member_id']?>" data-file="<?=$ticket['event_attachment']?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View Leave History">
...
<?php }elseif($action == "get_fy"){ ?>
  <table class="table border table-striped table-bordered display text-nowrap dataTable">
    ...
    <tbody>
      <?php 
        $fy = $con->getRows('leave_fy', array('order_by'=>'fy_id desc','return_type'=>'single'));
      if(!empty($fy)){?>
          <tr>
          <td>
            1
