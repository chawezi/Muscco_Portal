            ...
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user">
                <ul class="list-unstyled mb-0 d-flex align-items-center">
                  <li class="fw-semibold text-dark text-uppercase  fs-2">All Help Desk TICKETS</li>
              </div>
                  ...
                  <div class="chat-box p-9">
                    ...
                    <table id="scroll_hor" class="table border table-striped table-bordered display nowrap dataTable no-footer" style="width: 100%;" aria-describedby="scroll_hor_info">
                      ...
                      <tbody>
                        <?php
                          $sacco_name ='';
                          $tickets = $con->getRows('tickets a, products b', array('where'=>'a.ticket_product=b.product_id','order_by'=>'a.date_opened desc'));
                                ...
                                <td>
                                  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group me-2 mb-2" role="group" aria-label="First group">
                                      <a href="dashboard.php?page=help_desk_details&ticket_id=<?=$ticket['ticket_id']?>" class="btn btn-primary btn-sm btn_ticket_cancel" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View Details">
