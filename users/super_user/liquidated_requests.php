      ...
      <div class="col-9">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Liquidated Requests</li>
          </ol>
        </nav>
      </div>
      <div class="col-3">
  ...
  <div class="d-flex w-100">
            ...
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user">
                <ul class="list-unstyled mb-0 d-flex align-items-center">
                  <li class="fw-semibold text-dark text-uppercase  fs-2">Liquidated Requests</li>
              </div>
                ...
                <div class="position-relative">
                  <div class="chat-box p-9">
                    ...
                    <table id="scroll_hor" class="table border table-striped table-bordered display dataTable no-footer" style="width: 100%;" aria-describedby="scroll_hor_info">
                      ...
                      <tbody>
                        <?php
                          $leave = $con->getRows('travel_advance_request a, pillars b, travel_advance_liquidations d',
                                               array('where'=>'a.employee_id="'.$_SESSION['USR_ID'].'" and a.pillar=b.pillar_id and (a.request_status >2 and a.request_status <=5) and a.travel_advance_id=d.travel_advance_id', 'order_by'=>'a.date_posted desc'));
                          if(!empty($leave)){
                            $i=0;
    ...
    <div class="offcanvas offcanvas-start user-chat-box" tabindex="-1" id="chat-sidebar" aria-labelledby="offcanvasExampleLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel"> Travel Advance Liquidation </h5>
