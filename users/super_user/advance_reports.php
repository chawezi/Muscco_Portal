      ...
      <div class="col-9">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Advance Reports</li>
          </ol>
        </nav>
      </div>
      <div class="col-3">
  ...
  <div class="d-flex w-100">
          ...
          <div class="chat-box-inner-part h-100">
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user d-flex align-items-center justify-content-between">
                <h5 class="text-dark mb-0 fw-semibold">Advance Reports</h5>
                <div class="btn-toolbar mb-0 d-flex align-items-center" role="toolbar" aria-label="Toolbar with button groups">
                  <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
                    <button class="btn btn-primary btn-sm advancerequest_today" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Todays Report">
                      <i class="ti ti-report fs-4"></i> Today
                    </button>
                    <button class="btn btn-sm btn-warning btn-sm advancerequest_week" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="This Week Report">
                      <i class="ti ti-report fs-4"></i> Week
                    </button>
                    <button class="btn btn-sm btn-success btn-sm advancerequest_month" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="This Month Report">
                      <i class="ti ti-report fs-4"></i> Month
                    </button>
                    <button class="btn btn-sm btn-info btn-sm advancerequest_year" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="This Year Report">
                  ...
                  <div class="chat-box p-9">
                    <div class="table-responsive" width="100%">
                      ...
                      <form class="row g-3" id="advancereport-custom" name="advancereport-custom" method="post" action="">
                        ...
                        <div id="show_advance_request_report"></div>
    ...
    <div class="offcanvas offcanvas-start user-chat-box" tabindex="-1" id="chat-sidebar" aria-labelledby="offcanvasExampleLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel"> Advance Reports </h5>
