      ...
      <div class="col-9">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Approved   Sacco Loans</li>
          </ol>
        </nav>
      </div>
      <div class="col-3">
            ...
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user">
                <ul class="list-unstyled mb-0 d-flex align-items-center">
                  <li class="fw-semibold text-dark text-uppercase  fs-2">Approved  Loans</li>
              </div>
                  ...
                  <div class="chat-box p-9">
                    <div class="table-responsive" width="100%">
                      ...
                      <table id="scroll_hor" class="table border table-striped table-bordered display dataTable no-footer" style="width: 100%;" aria-describedby="scroll_hor_info">
                        ...
                        <tbody>
                          <?php
                            $loans = $con->getRows('loans a, sacco b', array('where'=>'a.loan_status=1 and a.sacco_id=b.sacco_id', 'order_by'=>'date_posted desc'));
                            if(!empty($loans)){
                              $balance = 0;
                                ...
                                <tr class="search-items">
                                  ...
                                  <td>
                                    <div class="action-btn">
                                      <a href="dashboard.php?page=loan_details&loan_id=<?=$loan['loan_id']?>" class="btn btn-primary btn-sm  ms-2"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Loan Details">
