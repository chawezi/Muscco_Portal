                      ...
                      <tbody>
                        <?php
                          $leave = $con->getRows('vehicle_requests a, muscco_members b, positions c',
                                           array('where'=>'a.requested_by=b.muscco_member_id and b.position_id=c.position_id and a.request_status=0 and a.requested_by !="'.$_SESSION['USR_ID'].'"', 'order_by'=>'date_requested desc'));
                          if(!empty($leave)){
                            $i=0;
                                ...
                                <td>
                                  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
                                      <a href="dashboard.php?page=vehicle_request_details&request_id=<?=$day['request_id']?>&action=authorize_vehicle" class="btn btn-primary btn-sm btn_day_cancel" data-bs-placement="top" data-bs-title="View Details"> Details
                                      </a>
                                    </div>
