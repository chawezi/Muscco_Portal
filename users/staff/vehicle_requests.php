      ...
      <div class="col-9">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">My Vehicle Request</li>
          </ol>
        </nav>
      </div>
      <div class="col-3">
            ...
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user">
                <ul class="list-unstyled mb-0 d-flex align-items-center">
                  <li class="fw-semibold text-dark text-uppercase  fs-2">My Vehicle Requests</li>
              </div>
                ...
                <div class="position-relative">
                  <div class="chat-box p-9">
                    ...
                    <table id="scroll_hor" class="table border table-striped table-bordered display dataTable no-footer" style="width: 100%;" aria-describedby="scroll_hor_info">
                      ...
                      <tbody>
                        <?php
                          $leave = $con->getRows('vehicle_requests a, muscco_members b',
                                           array('where'=>'a.requested_by=b.muscco_member_id','order_by'=>'date_requested desc'));
                          if(!empty($leave)){
                            $i=0;
                              ...
                              <tr class="search-items">
                                  ...
                                  <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                      <div class="user-meta-info">
                                        ...
                                        <span class="user-work fs-3" data-occupation=""><?=ucwords($day['driver_name'])?></span>
                                      </div>
                                    </div>
                                  </div>
                                </td>
                                <td>
                                  <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                      <div class="user-meta-info">
                                        <h6 class="user-name mb-0" data-name=""><?=ucwords($day['destination'])?></h6>
                                  ...
                                  <?php 
                                    switch ($day['request_status']) {
                                      ...
                                      case 1:
                                        ...
                                        break;
                                      case 2:
                                        echo'<span class="mb-1 badge rounded-pill bg-warning">Authorized</span>';
                                        break;
                                      
                                      case 3:
                                        echo'<span class="mb-1 badge rounded-pill bg-success">Authorized</span>';
                                        break;

                                      case 4:
                                        echo'<span class="mb-1 badge rounded-pill bg-success">Returned</span>';
                                        break;
                                    }
                                  ?>
                                </td>
                                ...
                                <td>
                                  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
                                      <a href="dashboard.php?page=vehicle_request_details&request_id=<?=$day['request_id']?>" class="btn btn-primary btn-sm btn_day_cancel" data-bs-placement="top" data-bs-title="View Details">
