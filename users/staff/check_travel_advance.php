                      ...
                      <tbody>
                        <?php
                          $leave = $con->getRows('travel_advance_request a, pillars b, muscco_members c',
                                           array('where'=>'a.employee_id=c.muscco_member_id and a.pillar=b.pillar_id and a.request_status=0', 'order_by'=>'a.date_posted desc'));
                          if(!empty($leave)){
                            $i=0;
                                ...
                                <td>
                                  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
                                      <a href="dashboard.php?page=travel_advance_details&request_id=<?=$day['travel_advance_id']?>&action=check_request" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Check Request">
