                      ...
                      <tbody>
                        <?php
                          $leave = $con->getRows('leave_applications a, leave_fy b, leave_types c, muscco_members d, departments e',
                                                  array('where'=>'a.member_id=d.muscco_member_id and a.fy_id=b.fy_id and a.leave_type=c.type_id and a.leave_status=2 and d.department_id=e.department_id and a.member_id !="'.$_SESSION['USR_ID'].'"', 'order_by'=>'a.date_requested'));
                          if(!empty($leave)){
                            $i=0;
