                          ...
                          <tbody>
                            <?php
                              $leave = $con->getRows('travel_advance_request a, pillars b, muscco_members c, travel_advance_liquidations d',
                                               array('where'=>'a.employee_id=c.muscco_member_id and a.pillar=b.pillar_id and a.request_status=4 and a.travel_advance_id=d.travel_advance_id', 'order_by'=>'a.date_posted desc'));
                              if(!empty($leave)){
                                $i=0;
                                    ...
                                    <td>
                                      <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                        <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
                                          <a href="dashboard.php?page=liquidate_request&request_id=<?=$day['travel_advance_id']?>&action=approve_request" class="btn btn-primary btn-sm " data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Approve Request">
