...
if($action == "show_responses"){
  $responses = $con->getRows('ticket_response a, muscco_members b', array('where'=>'a.ticket_id="'.$_GET['id'].'" and a.member_id=b.muscco_member_id', 'order_by'=>'a.date desc'));
  if(!empty($responses)){
          ...
          <a href="javascript:void(0)"
            ...
            <div class="position-relative w-100 ms-2">
              <div class="d-flex align-items-center justify-content-between mb-2">
                <h6 class="mb-0"><?=ucwords($response['first_name'])." ".ucwords($response['last_name'])?></h6>
              </div>
