  ...
  $(document).ready(function(){
    ...
    function requestAdvance() {    
      ...
      $.ajax({        
        ...
        beforeSend: function(){ 
          ...
          $("#verify_advance").html(' Submitting...');
          $("#check_advance").html(' Submitting...');
    ...
    function addInvoice() {    
      ...
      $.ajax({        
        ...
        success : function(response){ //alert(response);
          ...
          if(response == 9) {                 
            $("#response").fadeIn(1000, function(){            
              $("#response").html('<div class="alert alert-success"> A loan status has been updated successfuly.</div>');
              $("#change_status").html('Update Status');
            });
            setTimeout(' window.location.href = ""; ', 4000);
          }
          if(response == 10) {                 
            $("#response").fadeIn(1000, function(){            
              $("#response").html('<div class="alert alert-success"> Sorry, there was an error in updating the loan status.</div>');
              $("#change_status").html('Update Status');
            });
            $("#response").delay(10000).fadeOut(function(){});
          }
    ...
    $("#leave-type").validate({
      ...
      messages: {
        ...
        reasons:"Please enter a remark",
        holiday:"Please enter the public holiday",
      ...
      $.ajax({        
        ...
        success : function(response){ //alert(response);
          if(response == 1) {                 
            ...
            $("#product_response").fadeIn(500, function(){            
              $("#product_response").html('<div class="alert alert-success"> The Public holiday has been recorded successfuly.</div>');
            });
            setTimeout(' window.location.href = ""; ', 6000);
          }
          else if(response == 10) {                 
            $("#product_response").fadeIn(1000, function(){            
              $("#product_response").html('<div class="alert alert-danger"> Sorry, there was an error saving the public holiday, please try again.</div>');
            });
            $("#product_response").delay(6000).fadeOut(function(){});
          }
    ...
    function vehicleRequest() {    
      ...
      $.ajax({        
        ...
        success : function(response){ //alert(response);
          ...
          if(response == 3) {                 
            $("#error").fadeIn(1000, function(){            
              $("#error").html('<div class="alert alert-success"> Your travel advance request has been submitted successfully!</div>');
              $("#vehicle_request").html('Submit Request');
              $("#vehicle-request")[0].reset();
            });
            $("#error").delay(6000).fadeOut(function(){});
            ...
            $("#error").fadeIn(1000, function(){            
              $("#error").html('<div class="alert alert-success"> Your travel advance liquidation has been submitted successfully!</div>');
              $("#vehicle_request").html('Liquidate');
            });
            $("#error").delay(6000).fadeOut(function(){});
            ...
            $("#error").fadeIn(1000, function(){            
              $("#error").html('<div class="alert alert-danger"> Sorry, there was an error submitting your liquidation information, please try again </div>');
              $("#vehicle_request").html('Liquidate');
            });
            $("#error").delay(6000).fadeOut(function(){});
          }
            ...
            $("#error").fadeIn(1000, function(){            
              $("#error").html('<div class="alert alert-danger"> Sorry, there was an error uploading your receipts, please try again </div>');
              $("#vehicle_request").html('Liquidate');
            });
            $("#error").delay(9000).fadeOut(function(){});
          }
          else if(response == 10) {                 
            $("#error").fadeIn(1000, function(){            
              $("#error").html('<div class="alert alert-danger"> Sorry, the attached receipts format is invalid, please make sure it is of type png, jpeg, jpg or pdf </div>');
              $("#vehicle_request").html('Liquidate');
            });
            $("#error").delay(6000).fadeOut(function(){});
          }
    ...
    function assignVehicle() {    
      ...
      $.ajax({        
        ...
        success : function(response){ //alert(response);
          ...
          if(response == 11) {                 
            $("#authorize_response").fadeIn(1000, function(){            
              $("#authorize_response").html('<div class="alert alert-success"> A travel advance liquidation has been marked as approved successfully!</div>');
              $("#approve_request").html('Approve');
              $("#assign-vehicle")[0].reset();
            });
            $("#authorize_response").delay(6000).fadeOut(function(){});
            ...
            $("#authorize_response").fadeIn(1000, function(){            
              $("#authorize_response").html('<div class="alert alert-danger"> Sorry, there was an error marking the travel advance liquidation as approved, please try again!</div>');
              $("#approve_request").html('Approve');
            });
            $("#authorize_response").delay(6000).fadeOut(function(){});
          }
       ...
       if(confirm("Are you sure you want to delete this leave type?"))
       {
           ...
           $.ajax({
               ...
               success:function(data){ //alert(data);
                   if(data == 1){
                       $("#product_response").fadeIn(1000, function(){
                           $("#product_response").html('<div class="alert alert-success" role="alert"> The selected leave type has been deleted successfully!</div>');
                       });
                       setTimeout(' window.location.href = ""; ', 6000);
                   }else{
                       $("#product_response").fadeIn(1000, function(){
                           $("#product_response").html('<div class="alert alert-warning" role="alert"> Sorry, there was an error deleting the  selected leave type, please try again!</div>');
                       });
                       $("#product_response").delay(6000).fadeOut(function(){});
                   }
               }
    ...
    //update_fy
    $(document).on('click', '.update_fy', function(){
       var id=$(this).data("id3");

       if(confirm("Are you sure you want to update the financial year?"))
       {
           var action='update_fy';
           $.ajax({
               url:"../../settings/sql-master.php",
               method:"GET",
               data:{id:id, action:action},
               ...
               success:function(data){ alert(data);
                   if(data == 1){
                       $("#product_response").fadeIn(1000, function(){
                           $("#product_response").html('<div class="alert alert-success" role="alert"> The financial year has been updated successfully!</div>');
                       });
                       setTimeout(' window.location.href = ""; ', 6000);
                   }else{
                       $("#product_response").fadeIn(1000, function(){
                           $("#product_response").html('<div class="alert alert-warning" role="alert"> Sorry, there was an error updating the financial year, please try again!</div>');
                       });
                       $("#product_response").delay(6000).fadeOut(function(){});
                   }
               }
   ...
   if(confirm("Are you sure you want to mark this event as complete?"))
   {
    ...
    //delete_topic
    $(document).on('click', '.btn_delete_holidy', function(){
       var id=$(this).data("id3");


       if(confirm("Are you sure you want to delete this holiday?"))
       {
           var action='delete_holiday';
           $.ajax({
               url:"../../settings/sql-master.php",
               method:"GET",
               data:{id:id, action:action},
               ...
               success:function(data){ //alert(data);
                   if(data == 1){
                       $("#product_response").fadeIn(500, function(){
                           $("#product_response").html('<div class="alert alert-success" role="alert"> The selected holiday has been deleted !</div>');
                       });
                       $("#product_response").delay(6000).fadeOut(function(){});
                       setTimeout(' window.location.href = ""; ', 6000);
                   }else{
                       $("#product_response").fadeIn(500, function(){
                           $("#product_response").html('<div class="alert alert-warning" role="alert"> Sorry, there was an error deleting the  selected topic!</div>');
                       });
                       $("#product_response").delay(6000).fadeOut(function(){});
                   }
               }
