                ...
                <div class="row pt-3">
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="emp_number" value="<?=$member['employee_id']?>" disabled>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="mb-3">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <input type="date" class="form-control" name="dos" value="<?=$member['join_date']?>" disabled>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="mb-3">
                      <label class="control-label">Department</label>
                      <select class="form-control form-select" name="department" tabindex="1" disabled>
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                      ...
                      <select class="form-control form-select" name="position" tabindex="1" disabled>
