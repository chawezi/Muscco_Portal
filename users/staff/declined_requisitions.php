            ...
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user">
                <ul class="list-unstyled mb-0 d-flex align-items-center">
                  <li class="fw-semibold text-dark text-uppercase  fs-2">Declined Petty Cash Requisitions</li>
              </div>
                    	...
                    	<div class="table-responsive">
					                  <table id="zero_config" class="table border table-striped table-bordered display dataTable no-footer">
														  ...
														  <tbody>
														  	<?php
														  		$requisitions =$con->getRows('petty_cash_requisitions a, muscco_members b, departments c',
														  						 						   array('where'=>'a.requested_by=b.muscco_member_id and b.department_id=c.department_id and a.requisition_status=2','order_by'=>'a.date_posted desc'));
				                                    ...
				                                    <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
				                                      <a href="dashboard.php?page=petty_cash_details&request_id=<?=$row['requisition_id']?>&action=approve_requisition" class="btn btn-primary btn-sm btn_day_cancel" title="View Details" data-bs-placement="top" data-bs-title="View Details">
