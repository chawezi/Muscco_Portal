  ...
  <div class="d-flex w-100">
          ...
          <div class="chat-box-inner-part h-100">
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user d-flex align-items-center justify-content-between">
                <h5 class="text-dark mb-0 fw-semibold">Supervisor Approval</h5>
                    		...
                    		<table id="scroll_hor" class="table border table-striped table-bordered display nowrap dataTable no-footer" style="width: 100%;" aria-describedby="scroll_hor_info">
														  ...
														  <tbody>
														  	<?php
														  		$requisitions = $con->getRows('advance_requests a, muscco_members b, departments c', 
														  						 array('where'=>'a.requested_by=b.muscco_member_id and b.department_id=c.department_id and a.advance_status=0 and a.requested_by !="'.$_SESSION['USR_ID'].'"','order_by'=>'date_posted desc'));
				                                  ...
				                                  <div class="d-flex align-items-center">
				                                    ...
				                                    <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
				                                      <a href="dashboard.php?page=advance_details&advance_id=<?=$row['advance_id']?>&action=verify_advance" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Verify Request">
    ...
    <div class="offcanvas offcanvas-start user-chat-box" tabindex="-1" id="chat-sidebar" aria-labelledby="offcanvasExampleLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel"> Check Advances </h5>
