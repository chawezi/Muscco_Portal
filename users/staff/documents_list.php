        ...
        <div class="col-9">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Documents <h5 style="color: #0af53a" id="numCount"><h5></h5></h5></li>
            </ol>
          </nav>
        </div>
        <div class="col-3">
                    ...
                    <tbody>
                      <?php
                        $documents = $con->getRows('documents a, document_categories b', 
                                 array('where'=>'a.category_id=b.category_id and (a.access_rights=0 or a.access_rights=1)','order_by'=>'title asc'));
                        if(!empty($documents)){
                          $i=0;
