...
$user_name = '';
$ticket = $con->getRows('tickets a, muscco_members b, products c, ticket_categories d',
                        array('where'=>'a.posted_by=b.muscco_member_id and a.ticket_product=c.product_id and a.ticket_id="'.$ticket_id.'" and a.ticket_category=d.ticket_category_id', 'return_type'=>'single')
                        );
?>
                  ...
                  <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><div class="progress progress-bar bg-danger text-white" style="width: 50%; height: 20%;" role="progressbar">50%</div></td>
                        </tr>
                        <tr>
