      ...
      <div class="col-9">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Return Vehicle</li>
          </ol>
        </nav>
      </div>
      <div class="col-3">
            ...
            <div class="chatting-box app-email-chatting-box">
              <div class="p-9 py-3 border-bottom chat-meta-user">
                <ul class="list-unstyled mb-0 d-flex align-items-center">
                  <li class="fw-semibold text-dark text-uppercase  fs-2">Return Vehicle</li>
              </div>
                      ...
                      <tbody>
                        <?php
                          $leave = $con->getRows('vehicle_requests a, muscco_members b, positions c',
                                           array('where'=>'a.requested_by=b.muscco_member_id and b.position_id=c.position_id and a.request_status=2', 'order_by'=>'date_requested desc'));
                          if(!empty($leave)){
                            $i=0;
                              ...
                              <tr class="search-items">
                                ...
                                <td>
                                  <div class="d-flex align-items-center">
                                    <div class="ms-3">
                                      <div class="user-meta-info">
                                        <h6 class="user-name mb-0" data-name=""><?=ucwords($day['driver_name'])?></h6>
                                        <span class="user-work fs-3" data-occupation=""><?=$day['vehicle_assigned']?></span>
                                      </div>
                                    </div>
                                  </div> 
                                </td>
                                ...
                                <td>
                                  <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group me-2 mb-2" role="group" aria-label="First group">                                   
                                      <a href="dashboard.php?page=vehicle_request_details&request_id=<?=$day['request_id']?>&action=return_vehicle" class="btn btn-primary btn-sm btn_day_cancel" data-bs-placement="top" data-bs-title="View Details">
