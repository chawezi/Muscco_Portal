        ...
        <div class="card card-body">
          <div class="d-sm-flex d-block align-items-center justify-content-between mb-7">
            <div class="mb-3 mb-sm-0">
              ...
              <p class="card-subtitle mb-0">Topics posted for discussions</p>
            </div>
          </div>
          <div class="table-responsive">
            ...
            <tbody>
              <?php
                $topics = $con->getRows('discussions a, muscco_members b', array('where'=>'a.posted_by=b.muscco_member_id and (access_rights=1 or access_rights=2)','order_by'=>'a.date_posted desc'));
                if(!empty($topics)){
                  $i=0;
