  ...
  $(document).ready(function(){
    ...
    $("#add-invoice").validate({
      ...
      messages: {
        ...
        description:"Please enter loan description/purpose.",
        invoice_number:"Please enter invoice number",
        invoice:"Please attach the scanned loan application form",
    ...
    function addInvoice() {    
      ...
      $.ajax({        
        ...
        beforeSend: function(){ 
          ...
          $("#apply_loan").html('Saving Application...');
        },
        success : function(response){ //alert(response);
          ...
          if(response == 9) {                 
            $("#response").fadeIn(1000, function(){            
              $("#response").html('<div class="alert alert-success"> A loan application has been submitted successfuly.</div>');
              $("#apply_loan").html('Apply Loan');
            });
            setTimeout(' window.location.href = ""; ', 4000);
          }
          if(response == 10) {                 
            $("#response").fadeIn(1000, function(){            
              $("#response").html('<div class="alert alert-error"> Sorry, there was an error submitting the loan application.</div>');
              $("#apply_loan").html('Apply Loan');
            });
            $("#response").delay(6000).fadeOut(function(){});
          }
