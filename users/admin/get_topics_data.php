            ...
            <td>
              <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group me-2 mb-2" role="group" aria-label="First group">
                  <a href="dashboard.php?page=open_topic&topic_id=<?=$note['topic_id']?>" class="btn btn-primary btn-sm delete_topic">
    ...
    foreach ($comments as $comment) {
      ...
      <div class="p-4 rounded-2 bg-light mb-3">
        <div class="d-flex align-items-center gap-3">
          ...
          <span class="fs-2"><span class="p-1 bg-muted rounded-circle d-inline-block"></span> <?=$comment['date_replied']?></span>
        </div>
