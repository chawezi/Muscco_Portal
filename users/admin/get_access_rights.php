...
if(!empty($access_rights)){ 
  ...
  <div class="d-flex align-items-center justify-content-between py-3 border-bottom">
    ...
    <button class="btn btn-danger fs-6 d-flex align-items-center justify-content-center p-2 fs-4 rounded-circle revoke_permision" data-id3="<?=$right['granted_id']?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Revoke Permission">
