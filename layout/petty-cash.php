...
<ul class="list-group" style="height: calc(120vh - 400px)" data-simplebar>  
 	...
 	if(!empty($user_access)){
      ...
      foreach ($user_access as $user_a) { 
        ...
        ?>
				...
				<li class="list-group-item border-0 p-0 mx-9">
				  <a class="d-flex align-items-center gap-2 list-group-item-action text-dark px-3 py-8 mb-1 rounded-1"
				    href="dashboard.php?page=declined_requisitions"><i class="ti ti-cancel fs-5"></i>Declined Requisitions</a>
				</li>
 <?php     
        }
